        ...
        <section className="contenedor-servicios">
            ...
            <div className="contenedor-cajas">
                <div className="caja-servicio">
                    <img className="img-servicio" src={process.env.PUBLIC_URL + "/img/mto.jpg"} alt="img.mantenimiendo"/>
                    <h3>Mantenimiento</h3>
                ...
                <div className="caja-servicio">
                    <img className="img-servicio" src={process.env.PUBLIC_URL + "/img/reparacion.jpg"} alt="img.reparacion"/>
                    <h3>Reparación</h3>
                ...
                <div className="caja-servicio">
                    <img className="img-servicio" src={process.env.PUBLIC_URL + "/img/diagnostico.png"} alt="img.diagnostico"/>
                    <h3>Diagnóstico</h3>
