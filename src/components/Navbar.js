    ...
    return (
        <nav className="menu">
            <div className="logo-redes">
                ...
                <div className="redes">
                    <a href="https://www.instagram.com/myklikstore" className="redes-link" target="_blank" rel="noreferrer">
                        <img src="/icon/instagram-bln.png" alt="logo-instagram" className="redes-logo"/>
                    </a>
                    <a href="https://www.tiktok.com/@myklikstore" className="redes-link" target="_blank" rel="noreferrer">
